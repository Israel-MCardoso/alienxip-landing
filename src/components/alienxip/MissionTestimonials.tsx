...
const slideData: TestimonialSlide[] = [
  ...
  },
  {
    ...
    tags: ["HubSpot CRM", "Tráfego Pago", "Automação"],
    description: "Implantação do CRM HubSpot e automação de processos comerciais, integradas a campanhas no Meta Ads e Google Ads para captação de leads qualificados e geração de novas matrículas.",
  },
  {
